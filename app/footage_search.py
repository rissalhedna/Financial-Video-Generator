    ...
    def _rank_results(
        ...
        def score(r: VideoResult) -> float:
            ...
            if is_portrait == video_portrait:
                ...
                aspect_score = 20  # Square is acceptable
            else:
                aspect_score = 5
    ...
    def fetch_video(
        ...
        for candidate in ranked[:3]:
            try:
                ...
                self._last_result = candidate  # Track for metadata
...
def fetch_visuals_for_script(
    ...
    for task in tasks:
        if not force_refresh and is_cached(task["dest"]):
            from .utils.download import get_video_info
            ...
            for future in tqdm(concurrent.futures.as_completed(futures), 
                ...
                try:
                    ...
                    if result:
                        ...
                        # Record metadata in cache manifest
                        download_info = fetcher.get_last_download_info()
                        if download_info:
